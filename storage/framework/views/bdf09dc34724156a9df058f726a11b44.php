    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderSkipped: false,
                backgroundColor: "#fff",
                data:  [130, 234, 125, 450, 200, 100, 220, 500, 100, 400, 230, 500],
                maxBarThickness: 6
            },],
        },
        options: {
    ...
    new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                data: [50, 40, 30, 22, 50, 25, 40, 23, 50, 34, 23, 40],
                maxBarThickness: 6
            ...
            },
                {
                    ...
                    fill: true,
                    data: [30, 90, 40, 14, 29, 29, 34, 23, 40, 34, 23, 40],
                    maxBarThickness: 6
                },
                {
                    label: "Tokopedia",
                    ...
                    backgroundColor: gradientStroke2,
                    fill: true,
                    data: [30, 90, 40, 140, 29, 29, 34, 23, 40, 34, 23, 40],
                    maxBarThickness: 6
                },
                {
                    label: "Lazada",
                    ...
                    backgroundColor: gradientStroke2,
                    fill: true,
                    data: [30, 90, 40, 14, 29, 290, 34, 23, 40, 34, 23, 40],
                    maxBarThickness: 6
                },
            ],
        },
...
<script src="<?php echo e(asset('custom/delete.js')); ?>"></script>
<?php /**PATH /home/shatomdc/public_html/sales.shatomedia.com/pengelola-order/resources/views/layouts/scripts.blade.php ENDPATH**/ ?>
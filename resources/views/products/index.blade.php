        ...
        <table class="table align-items-center justify-content-center mb-0 table-mobile-cards">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td data-label="Deskripsi" style="max-width: 200px;">
                <span class="text-xs font-weight-bold d-inline-block text-truncate w-100" style="max-width: 200px;" title="{{ $product->deskripsi }}">{{ $product->deskripsi }}</span>
              </td>
              ...
              <td class="align-middle text-center" data-label="Satuan">
                ...
                <td class="align-middle text-center" data-label="Aksi">
                  <div class="d-flex flex-wrap align-items-center justify-content-center gap-1">
                    <a class="btn btn-sm btn-link text-dark px-2 mb-0" href="/product/{{ $product->id }}/edit"><i class="fas fa-pencil-alt text-dark me-1" aria-hidden="true"></i>Edit</a>
                    <form action="/product/{{ $product->id }}" method="POST">
                      @method('DELETE')
                      @csrf
                      <button type="submit" class="btn btn-sm btn-link text-danger px-2 mb-0">

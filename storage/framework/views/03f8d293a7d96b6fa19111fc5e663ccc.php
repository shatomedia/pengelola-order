<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/dashboard">
            <img src="<?php echo e(asset('img/sidebar-logo.png')); ?>" class="navbar-brand-img" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: 100vh">
        ...
        <ul class="navbar-nav">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order')): ?>
                <li class="nav-item">
                    <a class="nav-link  <?php echo e(Request::is('order') || $title == 'Edit Penjualan' || $title == 'Tambah Penjualan' ? 'active' : ''); ?>"
                        href="/order">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(Request::is('product-category') ? 'active' : ''); ?>" href="/product-category">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(Request::is('proses-apriori') ? 'active' : ''); ?>" href="/proses-apriori">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Proses Apriori</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(Request::is('laporan-penjualan') ? 'active' : ''); ?>" href="/laporan-penjualan">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(Request::is('hasil-apriori') ? 'active' : ''); ?>"
                    href="<?php echo e(url('hasil-apriori')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Hasil Apriori</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(Request::is('account') ? 'active' : ''); ?>" href="/account">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<?php /**PATH /home/shatomdc/public_html/sales.shatomedia.com/pengelola-order/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>